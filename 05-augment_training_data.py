...
for file_name in tqdm(os.listdir(base_dir)):
    ...
    if "_" in file_name:
        ...
        shutil.copy(
            labels_dir + label_file_name,
            labels_dir + label_file_name.replace(".txt", "_blurred.txt"),
        )
        ...
        for key, code in conversions.items():
            ...
            shutil.copy(
                labels_dir + label_file_name,
                labels_dir + label_file_name.replace(".txt", f"_{key}.txt"),
            )
        ...
        shutil.copy(
            labels_dir + label_file_name,
            labels_dir + label_file_name.replace(".txt", "_noisy.txt"),
        )
